(function (global, factory) {
  ...
  var URDFJoint = /*#__PURE__*/function (_URDFBase4) {
    ...
    return _createClass(URDFJoint, [{
      ...
      value: function copy(source, recursive) {
        ...
        this.dependentMimicJoints = source.dependentMimicJoints.map(function (joint) {
          return joint.clone();
        });
      }
    }, {
  ...
  */
  ...
  var URDFDragControls = /*#__PURE__*/function () {
    ...
    return _createClass(URDFDragControls, [{
      key: "update",
      value: function update() {
        var raycaster = this.raycaster,
          hovered = this.hovered,
          manipulating = this.manipulating,
          scene = this.scene;
        if (manipulating) {
          return;
        }
        var hoveredJoint = null;
      ...
      key: "updateJoint",
      value: function updateJoint(joint, angle) {
        joint.setJointValue(angle);
      }
    }, {
      key: "onDragStart",
      value: function onDragStart(joint) {}
    }, {
      key: "onDragEnd",
      value: function onDragEnd(joint) {}
    }, {
      key: "onHover",
      value: function onHover(joint) {}
    }, {
      key: "onUnhover",
      value: function onUnhover(joint) {}
    }, {
      key: "getRevoluteDelta",
      value: function getRevoluteDelta(joint, startPoint, endPoint) {
        // set up the plane
        ...
        var direction = Math.sign(tempVector.dot(plane.normal));
        return direction * projectedEndPoint.angleTo(projectedStartPoint);
      }
    }, {
      key: "getPrismaticDelta",
      value: function getPrismaticDelta(joint, startPoint, endPoint) {
      ...
      key: "setGrabbed",
      value: function setGrabbed(grabbed) {
  ...
  var PointerURDFDragControls = /*#__PURE__*/function (_URDFDragControls) {
    function PointerURDFDragControls(scene, camera, domElement) {
      var _this;
      _classCallCheck(this, PointerURDFDragControls);
      ...
      _this._mouseDown = function (e) {
        updateMouse(e);
        raycaster.setFromCamera(mouse, _this.camera);
        _this.moveRay(raycaster.ray);
        _this.setGrabbed(true);
      };
      ...
      _this._mouseUp = function (e) {
        updateMouse(e);
        raycaster.setFromCamera(mouse, _this.camera);
        _this.moveRay(raycaster.ray);
        _this.setGrabbed(false);
      };
      domElement.addEventListener('mousedown', _this._mouseDown);
      domElement.addEventListener('mousemove', _this._mouseMove);
      domElement.addEventListener('mouseup', _this._mouseUp);
      return _this;
    }
    _inherits(PointerURDFDragControls, _URDFDragControls);
    return _createClass(PointerURDFDragControls, [{
      key: "getRevoluteDelta",
      value: function getRevoluteDelta(joint, startPoint, endPoint) {
        var camera = this.camera,
          initialGrabPoint = this.initialGrabPoint;
        ...
        if (Math.abs(tempVector.dot(plane.normal)) > 0.3) {
          return _get(_getPrototypeOf(PointerURDFDragControls.prototype), "getRevoluteDelta", this).call(this, joint, startPoint, endPoint);
        } else {
  ...
  var URDFManipulator = /*#__PURE__*/function (_URDFViewer) {
    function URDFManipulator() {
      ...
      var el = _this.renderer.domElement;
      var dragControls = new PointerURDFDragControls(_this.scene, _this.camera, el);
      dragControls.onDragStart = function (joint) {
      ...
      dragControls.onDragEnd = function (joint) {
      ...
      dragControls.updateJoint = function (joint, angle) {
        _this.setJointValue(joint.name, angle);
      };
      dragControls.onHover = function (joint) {
      ...
      dragControls.onUnhover = function (joint) {
      ...
      _this.dragControls = dragControls;
      return _this;
    }
    _inherits(URDFManipulator, _URDFViewer);
    return _createClass(URDFManipulator, [{
      key: "disableDragging",
      get: function get() {
